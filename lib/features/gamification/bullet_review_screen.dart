...
class _BulletReviewScreenState extends State<BulletReviewScreen>
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.wifi_off_outlined, size: 48, color: AppColors.textDisabled),
  ...
  Widget _buildBulletCard(BulletVersion bullet) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [BoxShadow(color: AppColors.background, offset: Offset(0, 3), blurRadius: 0)],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(fontSize: 14, color: AppColors.textDisabled, height: 1.4),
          ),
          const SizedBox(height: 24),
          TextField(
          ...
          Center(
            child: TextButton(
              ...
              child: const Text('Voltar para os bullets atuais', style: TextStyle(color: AppColors.textDisabled)),
            ),
          ),
        ],
      ),
  ...
  _AngleMeta _angleMeta(String angle) {
    switch (angle) {
      case 'processo':
        return _AngleMeta(Icons.settings_outlined, AppColors.primary, 'PROCESSO');
      case 'habilidade':
        return _AngleMeta(Icons.psychology_outlined, AppColors.warning, 'HABILIDADE');
      case 'resultado':
      default:
        return _AngleMeta(Icons.trending_up, AppColors.success, 'RESULTADO');
    }
  }
}
