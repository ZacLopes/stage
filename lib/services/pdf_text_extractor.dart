...
///
/// Retorna string vazia se o PDF for somente imagem (scan sem camada de texto).
/// Use [isUsable] para validar se o resultado tem conteúdo suficiente para
/// alimentar a análise de IA — abaixo de 200 caracteres provavelmente é scan
/// e precisaria de OCR (não suportado por enquanto).
