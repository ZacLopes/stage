...
| 9 | CI/testes | ✅ | `flutter test` **15/15** (6 antigos + 9 novos: matriz client, serialização, badge); analyze 0 errors, warnings = baseline 46; `migration list` limpo (84 local = remoto); manifest atualizado; CI roda no PR. |
