...
- **Usuários novos** (D-1): total + delta, top faculdades / cursos / semestres, taxas de AI consent / telefone / conclusão de onboarding
- **Engajamento**: DAU (swipes), CV adapters, appliers
- **Vagas inseridas** (D-1): total + delta, por área / fonte / empresa / modelo / tipo / cidade
- **Estoque atual**: vagas ativas totais, idade média, % com link externo, top áreas
...
supabase secrets set REPORT_EMAIL_TO="zackourilopes@outlook.com"
...
Ou aplicar direto a migration `20260521000000_cron_daily_report.sql` no projeto remoto.
